  ...
  <main>
    <div id="carouselExampleCaptions" class="carousel slide carrosel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
            <h5 class="info-carrosel">A importância de tomar vacina</h5>
    ...
    <div class="container my-4">
      ...
      <div class="text-center my-4">
        ...
        <a href="../../php/paginas/verificarAgendamento"><button type="button" class="btn btn-primary">Agendar</button></a>
      </div>
    </div>
  </main>